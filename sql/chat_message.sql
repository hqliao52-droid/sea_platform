...
CREATE TABLE `chat_message`  (
  ...
  `llm_refer_data` json NULL COMMENT '引用资料',
  `llm_refer_data_id` json NULL COMMENT '引用资料ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 211 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '存储用户 / LLM 的每一条消息内容' ROW_FORMAT = Dynamic;
