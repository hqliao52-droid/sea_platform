...
from app.schemas.user_push_notify_channel.user_push_notify_channel_schema import UserPushNotifyChannelSchema
from app.schemas.user_push_category_wegiht.user_push_category_wegiht_schema import UserPushCategoryWeightSchema
