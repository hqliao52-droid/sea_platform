...
class ChatMessage(Base):
    ...
    id = Column(
        Integer, primary_key=True, autoincrement=True, nullable=False, comment="消息ID"
    )
    ...
    current_user_ip_info = Column(
        String(255), nullable=True, default=None, comment="用户IP信息"
    )
    ...
    is_deleted = Column(
        SmallInteger, nullable=True, default=0, comment="是否删除？ 1=是  0=否"
    )
    created_time = Column(
        DateTime,
        nullable=False,
